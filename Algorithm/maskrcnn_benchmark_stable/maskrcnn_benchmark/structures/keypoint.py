...
def kp_connections(keypoints):
    kp_lines = [
        [keypoints.index('left_top'), keypoints.index('right_top')],
        [keypoints.index('right_top'), keypoints.index('right_down')],
        [keypoints.index('right_down'), keypoints.index('left_down')],
        [keypoints.index('left_down'), keypoints.index('left_top')],
    ]
    '''kp_lines = [
