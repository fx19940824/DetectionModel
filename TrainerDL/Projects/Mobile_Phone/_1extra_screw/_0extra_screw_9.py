...
right_image_dir = "/home/cobot/mobile_data/screw_train/right"
...
class ScrewData(Dataset):
    def __init__(self, left_image_dir, right_image_dir, temp_path, label_dir, img_transform=None,
        ...
        self.img_list1 = get_all_files(left_image_dir)[0:50]
        self.img_list2 = get_all_files(right_image_dir)[0:50]
        self.temp_path = temp_path
        self.label_list = get_all_files(label_dir)[0:50]
    ...
    def __getitem__(self, index):
        ...
        img2 = torch.from_numpy(image_loader(r_image_dir).astype(np.float32) + np.random.randint(-2, 2)).cuda()
...
def main():
    ...
    # -加载数据loader
    train_data = ScrewData(left_image_dir=left_image_dir, right_image_dir=right_image_dir, label_dir=label_dir,
                           temp_path=temp_path,
